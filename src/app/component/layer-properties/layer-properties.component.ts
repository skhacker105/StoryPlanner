...
export class LayerPropertiesComponent implements OnInit {
  ...
  propertyForm = new FormGroup({
    ...
    relativeWidth: new FormControl<number>(10, [Validators.required, Validators.min(0), Validators.pattern(/^\d+$/)]),
    relativeHeight: new FormControl<number>(10, [Validators.required, Validators.min(0), Validators.pattern(/^\d+$/)]),
    relativeLeft: new FormControl<number>(0, [Validators.required, Validators.pattern(/^\d+$/)]),
    relativeTop: new FormControl<number>(0, [Validators.required, Validators.pattern(/^\d+$/)]),
    endTime: new FormControl<number>(1, [Validators.required, Validators.min(0), Validators.pattern(/^\d+$/)])
  });
